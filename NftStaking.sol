...
import "@openzeppelin/contracts/token/ERC20/IERC20.sol"; //ERC20 토큰의 인터페이스
import "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol"; // ERC20 토큰을 안전하게 전송하기 위한 컨트랙트
import "@openzeppelin/contracts/token/ERC721/IERC721.sol"; // ERC721 토큰의 인터페이스
import "@openzeppelin/contracts/security/ReentrancyGuard.sol"; // 재진입공격 방지 보안계약

contract ERC721Staking is ReentrancyGuard {
    using SafeERC20 for IERC20; // NFT드롭하려는 주소로 자금을 전송할 때 안전한 전송 기능

    // Interfaces for ERC20 and ERC721
    IERC20 public immutable rewardsToken; // 보상 토큰
    IERC721 public immutable nftCollection; // NFT컬렉션
